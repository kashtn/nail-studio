      ...
      <div className="container mx-auto px-4 relative z-10 text-center md:text-left">
        <div className="max-w-xl">
          <h1 className="text-5xl md:text-6xl font-serif font-medium text-white mb-4 leading-tight">
            Поднимите свой <span className="text-pink-300">маникюр</span> на
            новый уровень
          </h1>
          <p className="text-xl text-gray-200 mb-8">
            Премиальные услуги по уходу за ногтями, созданные специально для вас
            и выполненные экспертами. Запишитесь сегодня и почувствуйте разницу.
          </p>
